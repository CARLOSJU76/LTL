<?php
    ...
    //función para alertar notificaciones de registro:
        ...
        function notifilogin($opcion, $user1, $perfil, $email){
            ...
            if ($opcion === 1) {
                echo json_encode(array("status" => "success", "message" => "Bienvenido $email, iniciaste sesión exitosamente.Nueva actualización. Perfil:".json_encode($array), "nombre" => $user1, "email"=>$email, "perfil" =>$array));
            } else if ($opcion === 0) {
