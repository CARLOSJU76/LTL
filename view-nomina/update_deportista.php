...
<div class="container mt-4">
    <div id="div-h2"><h3>LTL Website</h3></div>
        ...
        <form action="index.php?action=update_deportista" method="post" id="formulario_inserclubes" enctype="multipart/form-data">
    ...
    <table class="table" id="tabla_inser_clubes">
        ...
        <thead>
            <tr>
                <th colspan="2" class="text-center" id="head-inser_club">Edición de datos Deportistas</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                <td>
                    <div class="form-group">
                        <input type="text" name="nombre" id="nombre" placeholder="Nombre del Dirigente" class="form-control" value="<?= $data[0]['nombreD'] ?? '' ?>"required>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="form-group">
                        <input type="text" name="apellido" id="apellido" placeholder="Apellidos" class="form-control" value="<?= $data[0]['apellidoD'] ?? '' ?>"required>
                    </div>
                </td>
            </tr>
            <tr>
                    ...
                    <select name="modalidad" id="modalidad" class="form-select" required>
                        <option value="">Elija Modalidad</option>
                            <?php 
                                ...
                                $selected = ($mod['modalidad'] == $data[0]['modalidad']) ? 'selected' : '';
                                echo "<option value='".htmlspecialchars($mod['id'])."' $selected>"
