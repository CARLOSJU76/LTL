...
<head>
    ...
    <title>Inscripción Entrenadores</title>
...
<body>
    ...
    <div class="container" id="container_general">
        ...
        <form action="index.php?action=insert_entrenador" method="post" id="formulario_inserclubes" enctype="multipart/form-data">
        
            <table class="table" id="tabla_inser_clubes">
        <!-- Primera fila: Encabezado -->
                <thead>
                    <tr>
                        <th colspan="2" class="text-center" id="head-inser_club">Formulario Inscripción de Entrenadores</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="form-group">
                                <input type="text" name="nombre" id="nombre" placeholder="Nombre del Entrenador" class="form-control" required>
                            </div>
                        </td>
                    </tr>
                    <tr>
