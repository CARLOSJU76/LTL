...
<body>
    <header id="header-menu">
        ...
        <nav id="menu" class="menu-nav">
            <form action="index.php?action=trainer_manage" method="get" class="form-botones">
                <button type="submit" name="action" value="trainer_manage" class="botones_header">Gestión de Entrenamientos</button>
            </form>
