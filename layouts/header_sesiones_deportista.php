...
<body>
    <header id="header-menu">
        ...
        <nav id="menu" class="menu-nav">
            <form action="index.php?action=menu_sesiones" method="get" class="form-botones">
                <button type="submit" name="action" value="menu_sesiones" class="botones_header">Sesiones Programadas</button>
            </form>
