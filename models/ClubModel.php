<?php
    class ClubModel{
        ...
        public function insertRepresentante($nombre, $apellido, $codigo_td, $num_docum, $genero, $email){
                $consulta= "INSERT INTO representante_club (nombres, apellidos, codigo_tipodoc,
                            num_docum, genero, email) VALUES (?,?,?,?,?,?)";
                $stmt=$this->conn->prepare($consulta);
                $stmt->execute([$nombre, $apellido, $codigo_td, $num_docum, $genero, $email]);
        }
